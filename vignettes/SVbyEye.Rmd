...
```{r read_paf, echo=TRUE, message=FALSE, fig.dim = c(10, 3), dpi=36}
...
```{r simple_miro, echo=TRUE, message=FALSE, fig.dim = c(10, 3), dpi=36}
## Get PAF to plot
paf.file <- system.file("extdata", "test1.paf",
    package = "SVbyEye"
)
...
```{r miro_color, echo=TRUE, message=FALSE, fig.dim = c(10, 3), dpi=36}
...
```{r miro_idt, echo=TRUE, message=FALSE, fig.dim = c(10, 4), dpi=36}
...
```{r miro_bin, echo=TRUE, message=FALSE, fig.dim = c(10, 4), dpi=36}
...
```{r miro_break, echo=TRUE, message=FALSE, fig.dim = c(10, 4), dpi=36}
## Color by alignment by sequence identity
plotMiro(paf.table = paf.table, binsize = 1000, 
...
```{r add_annot, echo=TRUE, message=FALSE, fig.dim = c(10, 4), dpi=36}
## Make a plot
...
```{r lift_annot, echo=TRUE, message=FALSE, fig.dim = c(10, 4), dpi=36}
...
```{r SD_annot, echo=TRUE, message=FALSE, fig.dim = c(10, 4), dpi=36}
...
```{r annot_label, echo=TRUE, message=FALSE, fig.dim = c(10, 4), dpi=36}
...
```{r annot_level, echo=TRUE, message=FALSE, fig.dim = c(10, 4), dpi=36}
...
```{r annot_gene, echo=TRUE, message=FALSE, fig.dim = c(10, 4), dpi=36}
...
```{r add_aln, echo=TRUE, message=FALSE, fig.dim = c(10, 3), dpi=36}
## Make a plot
...
On many occasions alignments over the repetitive regions are redundant at positions of segmental duplications. This results in overlapping alignments that often flank inverted regions. There is a function that allows to break PAF alignments at these overlaps and report them as individual alignemnts.

```{r disjoinPAF, echo=TRUE, message=FALSE, fig.dim = c(10, 3), dpi=36}
...
```{r plotDisjoinPAF, echo=TRUE, message=FALSE, fig.dim = c(10, 3), dpi=36}
## Plot disjoined alignments
...
```{r highlightDisjoinPAF, echo=TRUE, message=FALSE, fig.dim = c(10, 4), dpi=36}
...
```{r getSVs, echo=TRUE, message=FALSE, fig.dim = c(10, 3), dpi=36}
...
```{r simple_AVA, echo=TRUE, message=FALSE, fig.dim = c(8, 5), dpi=36}
## Get PAF to plot
...
```{r extra_AVA, echo=TRUE, message=FALSE, fig.dim = c(8, 5), dpi=36}
...
```{r ord_AVA, echo=TRUE, message=FALSE, fig.dim = c(8, 5), dpi=36}
...
```{r annot_AVA, echo=TRUE, message=FALSE, fig.dim = c(8, 5), dpi=36}
...
```{r annotAVA_level, echo=TRUE, message=FALSE, fig.dim = c(8, 5), dpi=36}
...
```{r annotDups_AVA, echo=TRUE, message=FALSE, fig.dim = c(8, 5), dpi=36}
## Add annotation to the same level as are the sequence/sample alignments
plt <- plotAVA(paf.table = paf.table, color.by = 'direction')
annot.file <- system.file("extdata", "test_annot_ava.RData", package="SVbyEye")
annot.gr <- get(load(annot.file))
...
```{r SVs_AVA, echo=TRUE, message=FALSE, fig.dim = c(8, 5), dpi=36}
...
There are cases when one wants to visualize regions that are homologous to each other we offer functions to visualize alignments of a given sequence to itself. Such self alignments are typical for segmental duplications that are paralogous sequences with high sequence identity.

```{r self_aln, echo=TRUE, message=FALSE, fig.dim = c(10, 2), dpi=36}
## Get PAF to plot
...
```{r self_color, echo=TRUE, message=FALSE, fig.dim = c(10, 3), dpi=36}
## Plot alignment as arcs and color by alignment directionality
plotSelf(paf.table = paf.table, color.by = "direction", shape = "arc", 
         color.palette = c("+" = "azure3", "-" = "yellow3"))
```
...
```{r self_bin, echo=TRUE, message=FALSE, fig.dim = c(10, 3), dpi=36}
## Bin PAF alignments into user defined bin and color them by sequence identity (% of matched bases)
...
```{r self_SVs, echo=TRUE, message=FALSE, fig.dim = c(10, 3), dpi=36}
...
```{r seq_heat, echo=TRUE, message=FALSE, fig.dim = c(10, 3), dpi=36}
## Get PAF to plot
